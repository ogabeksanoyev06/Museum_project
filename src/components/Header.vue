		...
		>
			...
			<!-- <div class="d-flex align-items-center"> 
				<div class="me-3">
					...
					></router-link>
					<router-link :to="{}"
						><el-badge v-model="praduct" class="shop_kar item" type="primary">
							<svg
								data-v-398c99f6=""
								width="21"
								height="21"
...
.logo_menu.toggleMenu span:nth-child(3) {
	transform: translateX(60px);
}
.logo_menu.toggleMenu span:nth-child(1) {
	width: 30px;
	transform: translateY(0px) rotate(45deg);
}
.logo_menu.toggleMenu span:nth-child(2) {
	width: 30px;
